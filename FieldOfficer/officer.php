...
<head>
    ...
    <title>EcoLife Field Officer Dashboard</title>
        ...
        <div class="row">
            ...
            <div class="col-lg-2 col-md-3 col-sm-4 sidebar">
                ...
                <ul class="nav flex-column mt-5">
                    <li class="nav-item"><a id="dashboardLink" class="nav-link" href="officer.php"><i class="fas fa-home"></i> Dashboard</a></li>
                    <li class="nav-item"><a id="messageLink" class="nav-link" href="field_officer.php"><i class="fas fa-user" style="margin-right:10px;"></i>Manage Account</a></li>
                    <li class="nav-item"><a id="messageLink" class="nav-link" href="officer_dashboard.php"><i class="fas fa-envelope" style="margin-right:10px;"></i>Messages</a></li>
                    <li class="nav-item"><a id="messageLink" class="nav-link" href="logout.php"><i class="fas fa-arrow-left" style="margin-right:10px;"></i>Logout</a></li>
                </ul>
